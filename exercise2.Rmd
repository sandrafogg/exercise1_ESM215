...
geo1_df <- data.frame("Flow Accumulation" = 0.005231603, "Winter Radiation" = )
geo2_df <- data.frame("Flow Accumulation" = , "Winter Radiation" = )
geo3_df <- data.frame("Flow Accumulation" = , "Winter Radiation" = )
geo4_df <- data.frame("Flow Accumulation" = , "Winter Radiation" = )
geo5_df <- data.frame("Flow Accumulation" = , "Winter Radiation" = )
